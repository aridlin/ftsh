// --- CONFIGURATION ---
vec4 TRAIL_COLOR = vec4(1.0, 1.0, 1.0, 1.0); // can change to eg: vec4(0.2, 0.6, 1.0, 0.5);
...
const float THRESHOLD_MIN_DISTANCE = 0.05; // min distance to show trail (units of cursor height)
